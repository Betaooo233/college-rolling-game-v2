(function () {
  ...
  const CONFIG = {
    ...
    Storage: {
      ...
      titleBookKey: 'collegePersonaTitleBook_v1'
    },
    Loader: {
      audioTimeoutMs: 1800,
    ...
    Game: {
      ...
      flagSuccessBonus: 3,
      cardVariantRecentWindow: 6,
      cardVariantOfferWindow: 18,
      earlyVariantMinNegative: -6,
      lateVariantMinNegative: -12,
      flagCheckWeeks: [4, 8, 12, 16],
    ...
    Assets: {
      images: {
        ...
        campus_wall_panel: { path: 'assets/images/campus_wall_panel.png', role: '校园墙吐槽面板' },
        black_history_report: { path: 'assets/images/black_history_report_panel.png', role: '黑历史报告面板' },
        flag_scholarship: { path: 'assets/images/semester_flag_stickers_transparent_cut_1.png', role: '奖学金Flag贴纸' },
        flag_social: { path: 'assets/images/semester_flag_stickers_transparent_cut_2.png', role: '社交达人Flag贴纸' },
        flag_sleep: { path: 'assets/images/semester_flag_stickers_transparent_cut_3.png', role: '早睡Flag贴纸' },
        flag_direction: { path: 'assets/images/semester_flag_stickers_transparent_cut_4.png', role: '方向Flag贴纸' }
      },
      audio: {
        ...
        campusWallPing: { path: 'assets/audio/campus_wall_ping.mp3', volume: 0.46, loop: false },
        flagReveal: { path: 'assets/audio/flag_reveal.mp3', volume: 0.58, loop: false },
        blackReportStamp: { path: 'assets/audio/black_report_stamp.mp3', volume: 0.68, loop: false }
      }
    },
    Familiarity: {
      maxLevel: 3,
      weeklyGainLimit: 1,
      interventionCooldownActions: 4,
      floatX: 207,
      floatY: 350,
      names: { roommate: '舍友', classmate: '同学A', teacher: '老师A', senior: '社团前辈' },
      statuses: ['未认识', '认识', '熟悉', '关键时刻会帮你']
    },
    CampusWall: {
      recentPostWindow: 8,
      recentCommentWindow: 5,
      hotThreshold: 3,
      holdMs: 1000,
      autoFoldMs: 1000,
      posts: {
        class: ['匿名墙：有人突然开始记笔记，是觉醒还是老师A在附近？', '匿名墙：前排出现了疑似认真听课的稀有物种。'],
        library: ['匿名墙：固定座位那位同学今天又刷新了。', '匿名墙：图书馆座位像被某人绑定了账号。'],
        fish: ['匿名墙：有人说放松五分钟，结果错过了晚饭。', '匿名墙：短视频把一个人的时间切成了薯片。'],
        game: ['匿名墙：宿舍有人喊最后一把，这句话已经出现六次了。', '匿名墙：有人把复盘做出了写论文的气势。'],
        social: ['匿名墙：这个人怎么每个摊位都能遇到熟人？', '匿名墙：食堂拼桌现场刷新了一张新关系网。'],
        work: ['匿名墙：有人把课程表和排班表叠出了摩尔纹。', '匿名墙：现实副本今天又掉落了一点生活费。'],
        love: ['匿名墙：有人把课表研究成了约会避障算法。', '匿名墙：教学楼走廊今天心动指数略高。'],
        project: ['匿名墙：实验室灯还亮着，但人看起来不太亮了。', '匿名墙：文件名已经迭代到“最终最终真最终”。'],
        health: ['匿名墙：有人看起来像一份被风干的课程表。', '匿名墙：建议把睡眠加入必修课。'],
        flag: ['匿名墙：本学期 Flag 还活着，但呼吸有点急促。', '匿名墙：有人正在和开学时的豪言壮语对线。'],
        intervention: ['匿名墙：关键时刻真的有人伸手了，大学生活还没完全坏掉。']
      },
      comments: {
        roommate: ['舍友：最后一把的定义权不在人类手上。', '舍友：我已经把热水和零食放桌上了。', '舍友：他不是忘带钥匙，他是忘了宿舍还有床。'],
        classmate: ['同学A：资料我发了，但他看没看另说。', '同学A：甜是甜，期末也是真的。', '同学A：这份笔记建议立刻打开，不要只收藏。'],
        teacher: ['老师A：五分钟在大学里是一种危险单位。', '老师A：成长很好，但别把课当背景音。', '老师A：大学不是不能绕路，但要知道怎么回来。'],
        senior: ['社团前辈：很适合来我们这边继续发光发热。', '社团前辈：这份爆肝精神我们社团很熟。', '社团前辈：热闹也要留体力，真的。'],
        system: ['系统：建议尽快停止“明天一定开始”。', '系统：这条动态已加入黑历史候选。']
      },
      heatLabels: ['围观', '小热', '很热', '热帖']
    },
    SemesterFlags: [
      { id: 'flag_scholarship', name: '这学期我要拿奖学金', shortName: '奖学金', asset: 'flag_scholarship', fallbackColor: '#FFD166', successTitle: '奖学金冲刺者', failureText: '你离奖学金只差一个没熬夜的身体。', description: '期末学业 ≥80，健康 ≥40', stageHints: { 4: '第4周学业 ≥58', 8: '第8周学业 ≥65', 12: '第12周学业 ≥72' } },
      { id: 'flag_social', name: '我要成为社交达人', shortName: '社交', asset: 'flag_social', fallbackColor: '#7BDFF2', successTitle: '校园熟人王', failureText: '你认识了很多人，但也失去了不少电量。', description: '期末社交 ≥75，人物熟悉度总和 ≥8，人物剧情 ≥3', stageHints: { 4: '第4周社交 ≥50', 8: '第8周至少2名人物认识', 12: '第12周社交 ≥68' } },
      { id: 'flag_sleep', name: '我要不再熬夜', shortName: '早睡', asset: 'flag_sleep', fallbackColor: '#90BE6D', successTitle: '早睡奇迹', failureText: '你又一次在凌晨和自己和解失败。', description: '期末健康 ≥70，夜间行为 ≤5', stageHints: { 4: '第4周健康 ≥62', 8: '第8周夜间行为 ≤3', 12: '第12周健康 ≥66' } },
      { id: 'flag_direction', name: '我要找到方向', shortName: '方向', asset: 'flag_direction', fallbackColor: '#F4A261', successTitle: '路线清晰', failureText: '你的大学路线图仍然像被雨淋过。', description: '期末自我认同 ≥75，正向习惯 ≥2', stageHints: { 4: '第4周自我认同 ≥55', 8: '第8周有1个习惯', 12: '第12周自我认同 ≥68' } },
      { id: 'flag_money', name: '我要攒出生活费安全感', shortName: '生活费', asset: null, fallbackColor: '#B49FCC', successTitle: '饭卡回血王', failureText: '钱包确实努力了，但生活也确实很会扣款。', description: '期末金钱 ≥65，打工/实习 ≥4，健康 ≥35', stageHints: { 4: '第4周金钱 ≥38', 8: '第8周金钱 ≥48', 12: '第12周打工/实习 ≥3' } },
      { id: 'flag_skill', name: '我要做出一个代表作', shortName: '代表作', asset: null, fallbackColor: '#7BDFF2', successTitle: 'DDL 驯兽师', failureText: '代表作还在路上，deadline 已经先到宿舍门口。', description: '期末技能 ≥75，项目/比赛/创业 ≥5', stageHints: { 4: '第4周技能 ≥45', 8: '第8周技能 ≥55', 12: '第12周技能 ≥66' } }
    ],
    CardVariants: [
      { cardId: 'class', id: 'class_roll_call', title: '老师A突然点名', effects: { academic: 2, mood: -1 }, character: 'teacher', description: '你回答得不算完美，但至少证明自己在线。' },
      { cardId: 'class', id: 'class_sit_beside_a', title: '坐到同学A旁边', effects: { academic: -1, social: 3 }, character: 'classmate', description: '同学A小声提醒了本节重点，也顺手吐槽了你的笔记。' },
      { cardId: 'class', id: 'class_exam_focus', title: '讲到考试重点', effects: { academic: 4, identity: 1, health: -1 }, moment: 'highlight', description: '老师A说“这段了解一下”，全班瞬间开始写字。' },
      { cardId: 'sleep', id: 'sleep_alarm_fail', title: '闹钟全军覆没', effects: { health: 2, identity: -1 }, character: 'roommate', description: '你醒来时，课程群已经聊完一整轮人生。' },
      { cardId: 'sleep', id: 'sleep_dream_reboot', title: '梦里系统重启', effects: { mood: 3, health: 1 }, moment: 'highlight', description: '这觉睡得像给大脑装了补丁。' },
      { cardId: 'sleep', id: 'sleep_teacher_msg', title: '老师A发来提醒', effects: { academic: 1, mood: -1 }, character: 'teacher', description: '被窝里收到课程提醒，温柔但有压迫感。' },
      { cardId: 'club', id: 'club_booth_trap', title: '被摊位热情包围', effects: { social: 3, health: -1 }, character: 'senior', description: '你只是路过，却被塞了三张报名表。' },
      { cardId: 'club', id: 'club_plan_meeting', title: '策划会突然加时', effects: { social: 1, skill: 2, mood: -1 }, character: 'senior', description: '热闹是真的，耗电也是真的。' },
      { cardId: 'club', id: 'club_stage_light', title: '舞台灯照到你', effects: { mood: 2, identity: 2, money: -1 }, moment: 'highlight', description: '你突然觉得自己也可以成为校园传说的一小段。' },
      { cardId: 'game', id: 'game_dorm_squad', title: '宿舍五排开黑', effects: { social: 3, mood: 2, health: -2 }, character: 'roommate', description: '队友情比段位稳定，至少这一局是这样。' },
      { cardId: 'game', id: 'game_ranked_loss', title: '输到凌晨复盘', effects: { mood: -4, health: -2, skill: 3 }, moment: 'fail', description: '你说再来一把，时间说再见一晚。' },
      { cardId: 'game', id: 'game_campus_match', title: '意外打进校园赛', effects: { academic: -1, skill: 5, identity: 3 }, moment: 'highlight', description: '你第一次发现“打游戏”也能写进路线分。' },
      { cardId: 'library', id: 'library_fixed_seat', title: '固定座位召唤你', effects: { academic: 3, identity: 1 }, moment: 'highlight', description: '你和这个座位产生了稳定绑定关系。' },
      { cardId: 'library', id: 'library_note_swap', title: '和同学A交换资料', effects: { academic: 1, social: 2 }, character: 'classmate', description: '资料发过来了，至于看不看是另一个系统。' },
      { cardId: 'library', id: 'library_collect_only', title: '收藏资料但没翻开', effects: { academic: -1, mood: 2, identity: -1 }, moment: 'fail', description: '你不是在学习，你是在给收藏夹扩建宿舍。' },
      { cardId: 'video', id: 'video_endless_scroll', title: '三分钟变三小时', effects: { academic: -1, mood: 2, health: -1 }, moment: 'fail', description: '你本来只是想放松一下，算法却递来了时间黑洞。' },
      { cardId: 'video', id: 'video_algorithm_hit', title: '刷到精准安慰', effects: { mood: 4, identity: -1 }, moment: 'highlight', description: '系统比你更懂你今天想逃避什么。' },
      { cardId: 'video', id: 'video_anxiety_feed', title: '越刷越焦虑', effects: { mood: -2, identity: -2 }, moment: 'fail', description: '别人的大学生活看起来都开了会员。' },
      { cardId: 'dinner', id: 'dinner_midnight_hotpot', title: '夜宵锅突然开了', effects: { social: 2, mood: 3, health: -2, money: -2 }, character: 'roommate', description: '锅里煮着丸子，也煮着明天早八的风险。' },
      { cardId: 'dinner', id: 'dinner_split_bill', title: 'AA 算账奇迹', effects: { social: 1, mood: 1, money: 1 }, moment: 'highlight', description: '钱包短暂觉得自己被尊重了。' },
      { cardId: 'dinner', id: 'dinner_honest_talk', title: '吃着吃着聊人生', effects: { social: 2, health: -1, identity: 3 }, character: 'roommate', description: '一次普通加餐突然变成宿舍版深夜电台。' },
      { cardId: 'sport', id: 'sport_night_run', title: '操场夜跑回血', effects: { mood: 1, health: 4 }, moment: 'highlight', description: '风一吹，你的身体终于开始回蓝。' },
      { cardId: 'sport', id: 'sport_cat_walk', title: '校园猫陪走半圈', effects: { mood: 2, identity: 1 }, eggBoost: true, description: '校园猫像在审核你的本学期路线。' },
      { cardId: 'sport', id: 'sport_overdo', title: '热身过度', effects: { mood: 1, health: -2, skill: 2 }, moment: 'fail', description: '你想恢复体力，结果差点开启体育副本。' },
      { cardId: 'work', id: 'work_boss_praise', title: '店长突然夸你', effects: { skill: 2, money: 3 }, moment: 'highlight', description: '现实副本掉落了一点自信。' },
      { cardId: 'work', id: 'work_shift_crash', title: '排班撞上小测', effects: { academic: -3, health: -2, money: 4 }, moment: 'fail', description: '课程表和排班表在你面前打了起来。' },
      { cardId: 'work', id: 'work_customer_smile', title: '顾客一句谢谢', effects: { social: 1, mood: 2, money: 1 }, moment: 'highlight', description: '今天的劳累突然有了回声。' },
      { cardId: 'love', id: 'love_campus_walk', title: '校园散步绕远路', effects: { social: 1, mood: 3, money: -2 }, moment: 'highlight', description: '你把校园地图走成了心动路线。' },
      { cardId: 'love', id: 'love_message_anxiety', title: '等消息等到内耗', effects: { mood: -3, health: -1, identity: 1 }, moment: 'fail', description: '手机亮一下，你的注意力就重新投胎一次。' },
      { cardId: 'love', id: 'love_study_date', title: '约会顺便自习', effects: { academic: 3, social: 1, mood: 1 }, character: 'classmate', description: '课本和心动竟然短暂和平共处。' },
      { cardId: 'chat', id: 'chat_cafeteria_table', title: '食堂拼桌扩列', effects: { social: 3, mood: 1 }, character: 'classmate', description: '一顿饭的时间，你多认识了半张校园地图。' },
      { cardId: 'chat', id: 'chat_group_dive', title: '群聊潜水被点名', effects: { social: -2, mood: 2, identity: 1 }, moment: 'fail', description: '你以为自己很安静，群聊不这么认为。' },
      { cardId: 'chat', id: 'chat_link_person', title: '熟人介绍熟人', effects: { social: 2, skill: 1 }, character: 'senior', description: '校园人脉像藤蔓一样拐了个弯。' },
      { cardId: 'reject', id: 'reject_curtain_wall', title: '床帘结界展开', effects: { social: -2, mood: 1, health: 2 }, character: 'roommate', description: '世界很吵，你先把自己调成勿扰模式。' },
      { cardId: 'reject', id: 'reject_quiet_recover', title: '安静回血成功', effects: { mood: 1, identity: 2 }, moment: 'highlight', description: '拒绝不是逃跑，有时是给自己留电。' },
      { cardId: 'reject', id: 'reject_missed_news', title: '错过重要通知', effects: { academic: -1, social: -3, health: 1 }, moment: 'fail', description: '你躲过了热闹，也躲过了通知。' },
      { cardId: 'review', id: 'review_highlight', title: '荧光笔划到重点', effects: { academic: 4, mood: -1 }, moment: 'highlight', description: '重点被点亮的瞬间，焦虑也被标黄了。' },
      { cardId: 'review', id: 'review_last_minute', title: '临时抱佛脚加速', effects: { academic: 2, mood: -2, health: -3 }, moment: 'fail', description: '你不是复习完了，是把焦虑整理成了知识点。' },
      { cardId: 'review', id: 'review_study_partner', title: '同学A划重点', effects: { academic: 2, social: 2 }, character: 'classmate', description: '学习搭子出现，资料突然变得像人话。' },
      { cardId: 'competition', id: 'competition_team_carry', title: '队友突然靠谱', effects: { social: 2, skill: 2, identity: 1 }, character: 'classmate', description: '你第一次觉得组队不是玄学。' },
      { cardId: 'competition', id: 'competition_stage_fright', title: '上台前大脑空白', effects: { mood: -3, skill: 1, identity: 1 }, moment: 'fail', description: 'PPT 打开了，你的大脑差点没打开。' },
      { cardId: 'competition', id: 'competition_near_miss', title: '差点拿奖', effects: { mood: -1, skill: 4, identity: 2 }, moment: 'highlight', description: '虽然差一点，但你的技能树明显亮了。' },
      { cardId: 'project', id: 'project_build_runs', title: '方案终于跑通', effects: { skill: 4, health: -1, identity: 1 }, moment: 'highlight', description: '屏幕亮起成功提示，你也短暂亮了一下。' },
      { cardId: 'project', id: 'project_conflict', title: '文件版本打架', effects: { social: 1, mood: -3, health: -1, skill: 2 }, moment: 'fail', description: '你们不是在做项目，是在抢救项目。' },
      { cardId: 'project', id: 'project_demo_applause', title: '展示意外顺利', effects: { social: 2, skill: 2, identity: 2 }, moment: 'highlight', description: '掌声不大，但足够让你记很久。' },
      { cardId: 'intern', id: 'intern_commute_rush', title: '通勤冲刺成功', effects: { skill: 2, money: 2, health: -2 }, moment: 'fail', description: '你赶上了车，也丢了一点生命值。' },
      { cardId: 'intern', id: 'intern_mentor_tip', title: '前辈给出建议', effects: { skill: 4, identity: 1 }, moment: 'highlight', description: '一句话让你的简历路线清晰了一点。' },
      { cardId: 'intern', id: 'intern_meeting_blur', title: '会议听到灵魂出窍', effects: { mood: -2, health: -2, money: 2 }, moment: 'fail', description: '你人在会议里，灵魂在宿舍补觉。' },
      { cardId: 'startup', id: 'startup_pitch_deck', title: '路演稿改到发光', effects: { skill: 3, health: -1, identity: 2 }, moment: 'highlight', description: '商业计划书还没赚钱，先赚到了存在感。' },
      { cardId: 'startup', id: 'startup_budget_burn', title: '预算突然燃烧', effects: { money: -4, skill: 2, identity: 1 }, moment: 'fail', description: '梦想很贵，钱包先替你明白了。' },
      { cardId: 'startup', id: 'startup_brainstorm', title: '队友脑暴有效', effects: { social: 3, mood: 1, skill: 1 }, character: 'senior', description: '点子终于从“听起来很行”变成“也许真行”。' },
      { cardId: 'graduate', id: 'graduate_vocab_clock', title: '单词打卡不断', effects: { academic: 3, health: -2, identity: 1 }, moment: 'highlight', description: '你的未来规划开始出现咖啡味。' },
      { cardId: 'graduate', id: 'graduate_mock_exam', title: '模考突然清醒', effects: { academic: 4, mood: -2 }, moment: 'highlight', description: '分数不一定好看，但问题终于露面了。' },
      { cardId: 'graduate', id: 'graduate_coffee_plan', title: '咖啡续命计划', effects: { academic: 2, mood: 1, health: -3, identity: 1 }, moment: 'fail', description: '你押上的不只是题，还有睡眠。' }
    ],
    HiddenTitles: [
      { id: 'title_scholarship', name: '奖学金冲刺者', condition: 'flag_scholarship_success', text: '你真的把 Flag 从朋友圈搬进了成绩单。' },
      { id: 'title_social_king', name: '校园熟人王', condition: 'flag_social_success', text: '食堂门口自动刷新熟人，像开了人脉雷达。' },
      { id: 'title_sleep_miracle', name: '早睡奇迹', condition: 'flag_sleep_success', text: '你战胜了凌晨，也战胜了“再刷五分钟”。' },
      { id: 'title_direction_clear', name: '路线清晰', condition: 'flag_direction_success', text: '你的路线图终于没有被雨淋糊。' },
      { id: 'title_money_recover', name: '饭卡回血王', condition: 'flag_money_success', text: '饭卡余额回血，安全感短暂上线。' },
      { id: 'title_ddl_tamer', name: 'DDL 驯兽师', condition: 'skill_or_pressure', text: 'deadline 很凶，但这次被你牵着走。' },
      { id: 'title_lazy_study', name: '表面摆烂实际偷卷', condition: 'fish_high_academic', text: '你看似在摆，实际偷偷把分拿了。' },
      { id: 'title_collect_master', name: '资料收藏宗师', condition: 'library_note', text: '资料可能没全看，但收藏体系非常成熟。' },
      { id: 'title_coffee_server', name: '咖啡续命体', condition: 'low_health_high_core', text: '你不是在努力，是在用咖啡维持服务器。' },
      { id: 'title_curtain_guard', name: '床帘结界守护者', condition: 'dorm_curtain', text: '床帘一拉，世界变成低功耗模式。' },
      { id: 'title_cat_friend', name: '校园猫认证好友', condition: 'cat_friend', text: '猫路过都愿意多看你一眼。' },
      { id: 'title_money_math', name: '饭卡经济学家', condition: 'low_money_happy', text: '你用有限预算维持了精神体面。' },
      { id: 'title_schedule_vanish', name: '课表失踪术士', condition: 'skip_but_pass', text: '课表曾经失踪，期末又被你召回。' },
      { id: 'title_group_diver', name: '群聊潜水王', condition: 'low_social_comments', text: '你不常说话，但群聊总有你的影子。' },
      { id: 'title_shuffle_artist', name: '反复横跳艺术家', condition: 'many_categories_balanced', text: '你的大学生活像随机播放，但意外完整。' },
      { id: 'title_wall_star', name: '校园墙显眼包', condition: 'hot_wall', text: '你不是想出名，你只是每次都刚好离谱。' },
      { id: 'title_flag_reverse', name: 'Flag 反向大师', condition: 'flag_failed_strong_route', text: '你没完成目标，但完成了另一个自己。' },
      { id: 'title_normal_sample', name: '普通大学生观察样本', condition: 'fallback', text: '普通但真实，也很适合写进校园墙。' }
    ],
    ReportRules: {
      maxHighlights: 5,
      minHighlights: 3,
